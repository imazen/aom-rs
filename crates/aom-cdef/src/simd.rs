...
//!
//! Same aom-rs SIMD pattern as `aom_quant::simd`: ONE magetypes generic
...
use crate::{CDEF_BSTRIDE, CDEF_VERY_LARGE, PRI_TAPS, SEC_TAPS, cdef_dir, constrain, get_msb};

/// Dispatch entry used by [`crate::cdef_filter_block_16`] for width-8 blocks.
