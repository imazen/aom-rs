...
use crate::cospi::{NEW_INV_SQRT2, NEW_SQRT2, NEW_SQRT2_BITS};
use hand_v3::{
...
mod tests {
    ...
    fn cases() -> Vec<Case> {
        use K::{F, I};
        vec![
            Case { name: "idct4", size: 4, scalar: crate::av1_idct4, v3: I(Inv1d::Dct4) },
            Case { name: "idct8", size: 8, scalar: crate::av1_idct8, v3: I(Inv1d::Dct8) },
            Case { name: "idct16", size: 16, scalar: crate::av1_idct16, v3: I(Inv1d::Dct16) },
            Case { name: "idct32", size: 32, scalar: crate::av1_idct32, v3: I(Inv1d::Dct32) },
            Case { name: "idct64", size: 64, scalar: crate::av1_idct64, v3: I(Inv1d::Dct64) },
            Case { name: "iadst4", size: 4, scalar: crate::av1_iadst4, v3: I(Inv1d::Adst4) },
            Case { name: "iadst8", size: 8, scalar: crate::av1_iadst8, v3: I(Inv1d::Adst8) },
            Case { name: "iadst16", size: 16, scalar: crate::av1_iadst16, v3: I(Inv1d::Adst16) },
            Case { name: "iidentity4", size: 4, scalar: crate::av1_iidentity4, v3: I(Inv1d::Idtx4) },
            Case { name: "iidentity8", size: 8, scalar: crate::av1_iidentity8, v3: I(Inv1d::Idtx8) },
            Case {
                name: "iidentity16",
                size: 16,
                scalar: crate::av1_iidentity16,
                v3: I(Inv1d::Idtx16),
            },
            Case {
                name: "iidentity32",
                size: 32,
                scalar: crate::av1_iidentity32,
                v3: I(Inv1d::Idtx32),
            },
            Case { name: "fdct4", size: 4, scalar: crate::av1_fdct4, v3: F(Fwd1d::Dct4) },
            Case { name: "fdct8", size: 8, scalar: crate::av1_fdct8, v3: F(Fwd1d::Dct8) },
            Case { name: "fdct16", size: 16, scalar: crate::av1_fdct16, v3: F(Fwd1d::Dct16) },
            Case { name: "fdct32", size: 32, scalar: crate::av1_fdct32, v3: F(Fwd1d::Dct32) },
            Case { name: "fdct64", size: 64, scalar: crate::av1_fdct64, v3: F(Fwd1d::Dct64) },
            Case { name: "fadst4", size: 4, scalar: crate::av1_fadst4, v3: F(Fwd1d::Adst4) },
            Case { name: "fadst8", size: 8, scalar: crate::av1_fadst8, v3: F(Fwd1d::Adst8) },
            Case { name: "fadst16", size: 16, scalar: crate::av1_fadst16, v3: F(Fwd1d::Adst16) },
            Case { name: "fidentity4", size: 4, scalar: crate::av1_fidentity4, v3: F(Fwd1d::Idtx4) },
            Case { name: "fidentity8", size: 8, scalar: crate::av1_fidentity8, v3: F(Fwd1d::Idtx8) },
            Case {
                name: "fidentity16",
                size: 16,
                scalar: crate::av1_fidentity16,
                v3: F(Fwd1d::Idtx16),
            },
            Case {
                name: "fidentity32",
                size: 32,
                scalar: crate::av1_fidentity32,
                v3: F(Fwd1d::Idtx32),
            },
        ]
    }
