...
fn main() {
    ...
    for name in ["entropy_shim", "intra_shim", "sadvar_shim", "convolve_shim", "cdef_shim", "highbd_intra_shim", "hbd_lpf_shim", "hbd_sadvar_shim", "txb_shim", "intra_edge_shim", "quant_fp_shim", "wb_shim"] {
